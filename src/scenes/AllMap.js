...
class AllMap extends Phaser.Scene { 
    constructor(test) { 
        super({ key: 'AllMap' }); 
        } 
    preload() { 
        this.load.image('bg', '../../images/map/Bg2.png'); 
        ...
        this.load.image('lvs', '../../images/button/special.png');  
    ...
    create() { 
        ...
        playimage6 = this.add.image (395, 110, 'lvs');
        playimage6.setInteractive(); 
        playimage6.on ('pointerup', () => { 
            this.scene.start ('Game_lvs'); 
        });
    }
    update() { 
